"""
Database initialization with proper path setup
"""
import sys
import os
...
def add_sample_data():
    ...
    try:
        ...
        hospitals = [
            ...
            Hospital(
                name="Emergency Care Hospital H2",
                location_lat=28.5355,
                location_lng=77.3910,
                total_beds=180,
                available_beds=27,
                emergency_capacity_percent=85.0,
                emergency_services=True,
                ambulance_count=4,
                emergency_staff_count=18,
                road_accessibility="MEDIUM",
                flood_risk=25.0,
                contact_number="+91-11-9876543"
            )
        ]
        ...
        shelters = [
            ...
            Shelter(
                ...
                water_capacity=580,
                food_capacity=600,
                medical_capacity=120,
                sanitation_capacity=590,
                safe_capacity=580,
                available_capacity=460,
                is_operational=True,
                flood_risk=8.0,
                manager_name="Amit Patel",
                contact_number="+91-98765-65432"
            )
        ]
        ...
        households = [
            ...
            Household(
                ...
                emergency_phone="+91-99999-33333"
            ),
            Household(
                location_lat=28.5360,
                location_lng=77.3920,
                zone_id=3,
                total_population=6,
                children=3,
                elderly=1,
                ...
                emergency_phone="+91-99999-44444"
            )
        ]
...
def main():
    ...
    print("=" * 60)
    print("\n📌 Next steps:")
    print("   1. Run backend: python run_server.py")
